    ...
    <div className='container'>
      <Row>
        ...
        <TutorialStep title='進入NCTU+首頁，進行登入動作'>
          ...
          <img alt='0' className='img-responsive' src='https://plus.nctu.edu.tw/assets/courses-tutorial/0-fa348106ae03772e4e952ce79a6ac0f5.png' />
        </TutorialStep>
        <TutorialStep title='進入模擬排課頁面'>
          <img alt='1' className='img-responsive' src='https://plus.nctu.edu.tw/assets/courses-tutorial/1-b4c7600a9964c800aafb02d3ed80ec70.png' />
        </TutorialStep>
        <TutorialStep title='參考交大的課程時間表'>
          可以查詢自己科系的必修及選修科目。<br />
          在課程時間表首頁可找到代表課堂時間(如: 2GH)及教室地點(如: EC315)的代碼參考表。
          <img alt='3' className='img-responsive' src='https://plus.nctu.edu.tw/assets/courses-tutorial/3-88b65b3d0cf257a8a5afaa6ab3f8babd.png' />
        </TutorialStep>
        <TutorialStep title='在NCTU+模擬排課中查詢欲選的課程'>
          舉凡課名、教授、時間等篩選條件皆可直接查詢。<br />
          按下"+"即可選中，在右方的課表中加入該課程。<br />
          按下"★"即收藏該課程。
          <img alt='4' className='img-responsive' src='https://plus.nctu.edu.tw/assets/courses-tutorial/4-6e0af60501f4e05b4669aaf97d208b1e.png' />
        </TutorialStep>
        <TutorialStep title='衝堂判定功能'>
          若選到與已選的課程時間重疊的話，則會出現「衝堂」警示。
          <img alt='5' className='img-responsive' src='https://plus.nctu.edu.tw/assets/courses-tutorial/5-8ccf38d266be36c5b904d15af56ba324.png' />
        </TutorialStep>
      ...
      <Row>
        ...
        <TutorialStep title='點選「課程加退選」→「課程加選」進行加選'>
          ...
          <img alt='10' className='img-responsive' src='https://plus.nctu.edu.tw/assets/courses-tutorial/10-d67eda18df6f30f96b96f3bdcc1aa508.png' />
        </TutorialStep>
