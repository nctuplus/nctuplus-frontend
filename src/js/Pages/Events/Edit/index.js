            ...
            <div className='col-md-9 offset-1'>
              ...
              <div className='form-group'>
                <div className='row'>
                  ...
                  <div className='col-4'>
                    <input ref='begin_time' className='form-control' placeholder='必填' type='date' defaultValue={event.begin_time.slice(0, 10)} />
                  </div>
                  <label className='col-sm-2 control-label text-right'>結束時間</label>
                  <div className='col-4'>
                    <input ref='end_time' className='form-control' placeholder='必填' type='date' defaultValue={event.end_time.slice(0, 10)} />
                  </div>
                </div>
              </div>
